...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosMedicos>> listar(@PageableDefault(size = 10, sort= {"nome"}) Pageable paginacao){
        var page = repository.findAllByAtivoTrue(paginacao).map(DadosMedicos::new);
